...
# from fun_scrape import scrape_Wien_temps
...
t0 = 0
names = ['Wien_Hohe_Warte', 'Wien_Innere_Stadt', 'Wien_Stammersdorf', 'Wien_Donaufeld', 'Wien_Unterlaa',
         'Wien_Mariabrunn', 'Wien_Jubilaeumswarte', 'Gross_Enzersdorf', 'Schwechat_Flughafen', 'Brunn_am_Gebirge', ]
...
prom_Gauges = {n: {d: Gauge(f'ZamgFinal_{d}_{n}_{u}', f'Current {d} at {n} according to ZAMG') for d, u in zip(data, units)}for n in names}
